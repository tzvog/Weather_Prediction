...
class WeatherAccess:
    ...
    def __validate_and_return_lat_and_lon(location_string):
        ...
        if len(split_lat_lon) != 2:
            abort(BAD_REQUEST_CODE, "bad latitude and longitude format")
